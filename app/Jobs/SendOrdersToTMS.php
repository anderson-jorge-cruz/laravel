...
class SendOrdersToTMS implements ShouldBeUnique, ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($response->failed() || (json_decode($response->body())->entregas[0]->codMensagem == '2' && ! Str::contains(json_decode($response->body())->entregas[0]->mensagem, '000 - Erro Interno: duplicate key value violates unique constraint \"tbcadpes_pk\"'))) {
